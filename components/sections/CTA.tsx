        ...
        <div className="mx-auto max-w-3xl text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center rounded-lg border-2 border-white px-8 py-3 font-medium text-white hover:bg-primary-700 hover:shadow-primary transition-all duration-300 transform hover:scale-105"
            >
